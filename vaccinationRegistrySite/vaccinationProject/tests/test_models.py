...
from vaccinationProject.models import Facility, UserDetails, Vaccine, Visit
...
class TestModels(TestCase):
    def setUp(self):
        ...
        self.visit1 = Visit.objects.create(
            ...
            visit_time = '11:10:00',
            id_patient = None,
            id_facility = self.facility1,
            id_vaccine = self.vaccine1,
            took_place=0
        )
    ...
    def test_facitity(self):
        self.assertEquals(self.facility1.city,'Warszawa')
